<template>
  <div class="player">
    <div class="player-controls">
      <div id="stop" v-if="$vuetify.breakpoint.mdAndUp">
      ...
      <div id="mute" v-if="$vuetify.breakpoint.mdAndUp">
      ...
      <div id="volume" v-if="$vuetify.breakpoint.mdAndUp">
        <a
          v-on:click.prevent=""
